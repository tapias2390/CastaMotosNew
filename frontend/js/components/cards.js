  ...
  return `
    <a class="card" href="producto/${encodeURIComponent(product.slug)}" data-card-type="product" data-card-id="${product.id}">
      ...
      <div class="card__body">
        ...
        <span class="card__price">${helpers.formatCurrency(product.price)}${hasDiscount ? `<span class="card__price-old">${helpers.formatCurrency(product.previous_price)}</span>` : ''}</span>
  ...
  return `
    <a class="card" href="servicio/${encodeURIComponent(service.slug)}" data-card-type="service" data-card-id="${service.id}">
      ...
      <div class="card__body">
        ...
        <span class="card__price">${helpers.formatCurrency(service.price)}</span>
